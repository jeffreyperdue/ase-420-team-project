...
✅ Add multipliers for multiple lines (2, 3, 4) - completed in Week 6

- _Fulfills sub requirement 1.3_

✅ Integrate scoring logic with the board (trigger only after validated line removal) - completed in Week 6
